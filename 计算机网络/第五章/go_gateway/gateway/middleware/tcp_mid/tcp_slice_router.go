...
type TcpSliceRouterHandler struct {
	coreFunc func(*TcpSliceRouterContext) proxy.TCPHandler
...
func NewTcpSliceRouterHandler(coreFunc func(*TcpSliceRouterContext) proxy.TCPHandler, router *TcpSliceRouter) *TcpSliceRouterHandler {
