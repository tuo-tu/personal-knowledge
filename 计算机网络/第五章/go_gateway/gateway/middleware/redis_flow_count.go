...
func NewRedisFlowCountService(appID string, interval time.Duration) *RedisFlowCountService {
	...
	go func() {
		...
		for {
			...
			if err := common.RedisConfPipeline(func(c redis.Conn) {
...
func (o *RedisFlowCountService) GetDayKey(t time.Time) string {
	dayStr := t.In(common.TimeLocation).Format("20060102")
	return fmt.Sprintf("%s_%s_%s", common.RedisFlowDayKey, dayStr, o.AppID)
}

func (o *RedisFlowCountService) GetHourKey(t time.Time) string {
	hourStr := t.In(common.TimeLocation).Format("2006010215")
	return fmt.Sprintf("%s_%s_%s", common.RedisFlowHourKey, hourStr, o.AppID)
}

func (o *RedisFlowCountService) GetHourData(t time.Time) (int64, error) {
	return redis.Int64(common.RedisDefaultConfDo("GET", o.GetHourKey(t)))
}

func (o *RedisFlowCountService) GetDayData(t time.Time) (int64, error) {
	return redis.Int64(common.RedisDefaultConfDo("GET", o.GetDayKey(t)))
}
