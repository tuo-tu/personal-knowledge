...
## 1. 开发前提[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#1-开发前提)
...
## 2. Protobuf 协议增加与生成[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#2-protobuf-协议增加与生成)

### 编写 proto 文件[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#编写-proto-文件)
...
### 生成 Go 代码[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#生成-go-代码)
...
### 添加校验函数[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#添加校验函数)
...
## 3. API 功能添加[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#3-api-功能添加)

添加新的 API 功能，包括路由定义和接口定义。

### API 路由定义[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#api-路由定义)
...
### API 接口定义[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#api-接口定义)
...
## 4. 添加 RPC 方法[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#4-添加-rpc-方法)
...
### 添加新的 RPC 方法[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#添加新的-rpc-方法)
...
## 5. 添加存储层接口[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#5-添加存储层接口)
...
### 添加 controller 层接口[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#添加-controller-层接口)
...
### 添加 cache 层接口[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#添加-cache-层接口)
...
### 添加 database 层接口[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#添加-database-层接口)
...
## 1、定义 Server API 接口[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#1定义-server-api-接口)
...
## 2、实现 SDK 接口业务逻辑[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#2实现-sdk-接口业务逻辑)
...
## 3、处理 Server 下发通知[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#3处理-server-下发通知)
...
## 4、处理本地 DB 层[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#4处理本地-db-层)
...
## 5、导出层增加接口提供给其他语言使用[](https://docs.openim.io/zh-hans/guides/solution/developnewfeatures#5导出层增加接口提供给其他语言使用)
