...
![image-20220124162022990](Docker容器镜像.assets/image-20220124162022990.png)





![image-20220124162116338](Docker容器镜像.assets/image-20220124162116338.png)



![image-20220124162200273](Docker容器镜像.assets/image-20220124162200273.png)



![image-20220124162312918](Docker容器镜像.assets/image-20220124162312918.png)
...
![image-20220125080435098](Docker容器镜像.assets/image-20220125080435098.png)
...
![image-20220125082226414](Docker容器镜像.assets/image-20220125082226414.png)
...
可以。docker 通过 commit 和 build 操作实现镜像的构建。**commit 将正在运行的容器提交为一个镜像，build 在一个镜像的基础上（Dockerfile 文件）构建镜像。**
